...
class App {
    ...
    closeModal(event) {
        ...
        const isModalBtn = this.$closeModalForm.contains(event.target);
        if ((!isModalFormClickedOn || isModalBtn) && this.$modal.classList.contains("open-modal")) {
    ...
    handleToggleSidebar(){
        if(this.miniSidebar){
            ...
            this.$sidebarItem.classList.add("sidebar-active")
        }else{
            this.$sidebar.style.width = "80px";
            this.$sidebar.classList.remove("sidebar-hover");
            this.$sidebarItem.classList.remove("sidebar-active")
            this.miniSidebar = true;
        }
    }
    saveNotes(){
